...
func parseEvents() []event {
	...
	for _, e := range c.Events {
		...
		ev.Start = e.Start.Format("2006-01-02T15:04:00Z")
		ev.DayOfMonth = e.Start.Format("02")
		ev.Month = e.Start.Format("Jan")
		ev.DayOfWeek = e.Start.Format("Mon")
		ev.End = e.End.Format("2006-01-02T15:04:00Z")
